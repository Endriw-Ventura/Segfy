...
{
    public class CreateSinistroUseCase(ISinistroRepository sinistroRepository, IApoliceRepository apoliceRepository, IUnitOfWork unitOfWork, IMapper mapper) : ICreateSinistroUseCase
    {
        ...
        public async Task<SinistroDTO> ExecuteAsync(CreateSinistroDTO sinistro)
        {
